            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" >
                ...
                <div class="info-box bg-deep-orange hover-zoom-effect">
                    ...
                    <div class="content">
                        ...
                        <div class="text">Total Reported Cases</div>

                        <div class="number"><?php echo $reportsCount; ?></div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="info-box bg-indigo hover-zoom-effect">
                    ...
                    <div class="content">
                        ...
                        <div class="text">No. Of Males</div>

                        <div class="number"><?php echo $maleCount; ?></div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" >
                ...
                <div class="info-box bg-pink hover-zoom-effect">
                    ...
                    <div class="content">
                        ...
                        <div class="text">No. Of Females</div>

                        <div class="number"><?php echo $femaleCount; ?></div>
             ...
             <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" >
                ...
                <div class="info-box bg-purple hover-zoom-effect">
                    ...
                    <div class="content">
                        ...
                        <div class="text">Self Diagnosed Total</div>

                        <div class="number"><?php echo $selfdiagnosedcount; ?></div>
