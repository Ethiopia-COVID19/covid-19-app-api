...

{
...

    {
        ...
        $data["language"] = $this->Content_model->get_language('languages')->result();
...

    {
...

        {
            ...
            $this->form_validation->set_rules('Id', $this->lang->line("language"), 'trim|required|xss_clean');
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $dataArray = array(
                    ...
                    "content_category_id" => $this->input->post('content_category_id'),
                     ...
                     "content_language_id" => $this->input->post('Id'),
