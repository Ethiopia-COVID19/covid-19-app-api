                    ...
                    <div class="card">
                        ...
                        <div class="header">
                            ...
                            <h2>
                                ...
                                <?php echo $this->lang->line("Push Notifications List"); ?>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-hover dataTable" id="users_list2">
                                    ...
                                    <tr>
                                        ...
                                        <!-- <th><?php echo $this->lang->line("push_id"); ?></th> -->

                                        <th><?php echo $this->lang->line("push_title"); ?></th>

                                        <th><?php echo $this->lang->line("push_message"); ?></th>

                                        <th><?php echo $this->lang->line("push_url"); ?></th>
