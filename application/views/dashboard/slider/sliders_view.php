                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <!--<div class="form-group">
                                <div class="form-line">
                                    <select class="form-control show-tick" id="slider_content_id" name="slider_content_id" data-live-search="true" required>
                                        <option selected disabled><?php echo $this->lang->line("Select Related Game"); ?></option>
                                        <?php
                                        foreach ($getGameListTitle as $key) {
                                            ?>
                                            <option value="<?php echo $key->content_id; ?>"><?php echo $key->content_title; ?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
                            ...
                            if($_SESSION['user_role_id'] == 4 OR $_SESSION['user_role_id'] == 7) { ?>
                                <div class="alert alert-warning alert-dismissible" role="alert">
                                    <input type="hidden" name="slider_content_id" readonly="readonly" value="1" required>
