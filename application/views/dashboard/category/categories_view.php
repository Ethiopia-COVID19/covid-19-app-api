                                    ...
                                    <table id="slidersList" class="table table-striped dataTable">
                                        ...
                                        foreach ($categoriesList as $key) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php 
                                                if($key->category_language_id==1){
                                                    echo "Amharic";
                                                }elseif ($key->category_language_id==2) {
                                                    echo "Affan Oromo";
                                                }elseif ($key->category_language_id==3) {
                                                    echo "Tigrinya";
                                                }elseif ($key->category_language_id==4) {
                                                    echo "English";
                                                }elseif ($key->category_language_id==0) {
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="form-line">
                                            ...
                                            <select class="form-control show-tick" id="Id" name="Id" required>
                                                ...
                                                <option selected="selected" disabled> Select <?php echo $this->lang->line("language"); ?> *     </option>
                                                ...
                                                foreach ($language as $key) {
                                                    ...
                                                    <option value="<?php echo $key->Id; ?>"><?php echo $key->language_types ?></option>
