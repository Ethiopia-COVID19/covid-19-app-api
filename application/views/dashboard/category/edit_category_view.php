                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <div class="form-group">
                            ...
                            <label for="catagory_language_id" class="col-sm-3 control-label"><?php echo $this->lang->line("language"); ?> *</label>
                                ...
                                <div class="form-line">
                                    ...
                                    <select class="form-control show-tick" id="Id" name="Id" required>
                                        ...
                                        foreach ($language as $key) {
                                            ...
                                            $category_language_id_selected = "";

                                            if($key->Id == $categoryContent->category_language_id) $category_language_id_selected = "selected='selected'";

                                            ?>

                                            <option <?php echo $category_language_id_selected; ?> value="<?php echo $key->Id; ?>"><?php echo $key->language_types ?></option>
