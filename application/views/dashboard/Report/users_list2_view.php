                    ...
                    <div class="card">
                        ...
                        <div class="header">
                            ...
                            <h2>
                                ...
                                <?php echo $this->lang->line("Report List"); ?>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-hover dataTable" id="users_list2">
                                    ...
                                    <tr>
                                        ...
                                        <!-- <th><?php echo $this->lang->line("report_id"); ?></th> -->

                                        <th><?php echo $this->lang->line("report_firstname"); ?></th>

                                        <th><?php echo $this->lang->line("report_lastname"); ?></th>

                                        <th><?php echo $this->lang->line("report_sex"); ?></th>

                                        <th><?php echo $this->lang->line("report_age"); ?></th>

                                        <th><?php echo $this->lang->line("report_phone"); ?></th>

                                        <th><?php echo $this->lang->line("report_person"); ?></th>

                                        <th><?php echo $this->lang->line("report_city"); ?></th>

                                        <th><?php echo $this->lang->line("report_area"); ?></th>

                                         <th><?php echo $this->lang->line("report_occupation"); ?></th>

                                        <th><?php echo $this->lang->line("report_fever"); ?></th>

                                        <th><?php echo $this->lang->line("report_cough"); ?></th>

                                        <th><?php echo $this->lang->line("report_red_eyes"); ?></th>

                                        <th><?php echo $this->lang->line("report_shortness_of_breath"); ?></th>

                                         <th><?php echo $this->lang->line("report_travel_history"); ?></th>

                                        <th><?php echo $this->lang->line("report_contacted_with_pt_having_ssx"); ?></th>

                                        <th><?php echo $this->lang->line("report_Worked_or_visited_with_animal_market"); ?></th>

                                        <th><?php echo $this->lang->line("report_worked_or visited_HF_where_ads_cared"); ?></th>
                                    ...
                                    <tr>
                                       ...
                                       <!--  <td><a href="<?php echo base_url()."dashboard/User/show_user/$key->user_id"; ?>"><?php echo $key->id; ?></a></td>
                                        ...
                                        <!-- <td><?php echo $key->person; ?></td>-->
                                         <td> 

                                         <?php
                                        if($key->person==0){
                                          echo '<span style="color:black">MySelf</span>';
                                        }
                                        elseif ($key->person==1) {
                                          echo '<span style="color:black">Other Person</span>';
                                        }
                                            ?></td>
                                        ...
                                        <!-- <td><?php echo $key->fever; ?></td> -->

                                        <!-- <td><?php echo $key->cough; ?></td> -->
                                        ...
                                        elseif ($key->red_eyes==1) {
                                          echo '<span style="color:red">Yes</span>';
                                        }
                                            ?></td>

                                        <!-- <td><?php echo $key->shortness_of_breath; ?></td> -->

                                         <td>

                                         <?php
                                        if($key->shortness_of_breath==0){
                                          echo '<span style="color:green">No</span>';
                                        }
                                        elseif ($key->shortness_of_breath==1) {
                                          echo '<span style="color:red">Yes</span>';
                                        }
                                            ?></td>


                                        <!-- <td><?php echo $key->travel_history; ?></td> -->
                                         <td>

                                         <?php
                                        if($key->travel_history==0){
                                          echo '<span style="color:brown">No</span>';
                                        }
                                        elseif ($key->travel_history==1) {
                                          echo '<span style="color:blue">Yes</span>';
                                        }
                                            ?></td>

                                        <!-- <td><?php echo $key->contacted_with_pt_having_ssx; ?></td> -->
                                         <td>

                                         <?php
                                        if($key->contacted_with_pt_having_ssx==0){
                                          echo '<span style="color:brown">No</span>';
                                        }
                                        elseif ($key->contacted_with_pt_having_ssx==1) {
                                          echo '<span style="color:blue">Yes</span>';
                                        }
                                            ?></td>


                                       <!--  <td><?php echo $key->Worked_or_visited_with_animal_market; ?></td>-->
                                         <td> 

                                         <?php
                                        if($key->Worked_or_visited_with_animal_market==0){
                                          echo '<span style="color:brown">No</span>';
                                        }
                                        elseif ($key->Worked_or_visited_with_animal_market==1) {
                                          echo '<span style="color:blue">Yes</span>';
                                        }
                                            ?></td>

                                        <!-- <td><?php echo $key->worked_or_visited_HF_where_ads_cared; ?></td> -->
                                         <td> 

                                         <?php
                                        if($key->worked_or_visited_HF_where_ads_cared==0){
                                          echo '<span style="color:brown">No</span>';
                                        }
                                        elseif ($key->worked_or_visited_HF_where_ads_cared==1) {
                                          echo '<span style="color:blue">Yes</span>';
                                        }
                                            ?></td>
