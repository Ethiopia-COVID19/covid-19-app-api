...
<section class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
              ...
              <div class="col-lg-2 col-md-2 col-sm-5 col-xs-11" onclick="window.location.href='<?php echo base_url()."dashboard/Category/categories"; ?>';">
            ...
            <div class="col-lg-2 col-md-3 col-sm-5 col-xs-11" onclick="window.location.href='<?php echo base_url()."dashboard/Category/categories"; ?>';">
