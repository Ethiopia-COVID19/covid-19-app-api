...
class Report_model extends CI_Model {
    ...
    function selfdiagnosedcount()

    {

        $query = $this->db->get('selfdiagnosed_table');

        return $query->num_rows();

    }

function all_male_count()

    {

         $query = $this->db->get_where('report_table', array('sex' => '1'));

        return $query->num_rows();

    }

    function all_female_count()

    {

        $query = $this->db->get_where('report_table', array('sex' => '2'));
    ...
    function get_users_list3($table){
    ...
    function all_reports($limit,$start,$col,$dir)

    {

        $query = $this->db->query("Select report_table.*
...

    {
        ...
        $query = $this->db->query("Select report_table.*
                                ...
                                WHERE ((area LIKE '%$search%') OR (firstname LIKE '%$search%') OR (lastname LIKE '%$search%') OR (phone LIKE '%$search%')

                                OR (city LIKE '%$search%') OR (sex LIKE '%$search%')) 
