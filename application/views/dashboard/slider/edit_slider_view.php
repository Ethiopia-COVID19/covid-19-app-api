                    ...
                    <div class="body">
                                    ...
                                    <select class="form-control show-tick" id="slider_content_id" name="slider_content_id" data-live-search="true" required>
                                        ...
                                        foreach ($getGameListTitle as $key) {
                                            if($key->content_id == $sliderContent->slider_content_id)
                                                ...
                                                $slider_content_id_selected = "";
                                            ?>
                                            <option <?php echo $slider_content_id_selected; ?> value="<?php echo $key->content_id; ?>"><?php echo $key->content_title; ?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-9">
                                ...
                                <input type="hidden" readonly="readonly" name="slider_content_id" value="1" required>
