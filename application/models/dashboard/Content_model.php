...

{
...

    {
...

        {
            ...
            $q = $this->db->query("Select $table.*, category_table.category_title, languages.language_types, content_type_table.content_type_title, user_table.user_username, user_table.user_id, player_type_table.*
                                ...
                                ON $table.content_language_id = languages.Id 
    ...
    function get_game_list_title($table, $content_status){
        ...
        $q = $this->db->query("Select $table.content_id, $table.content_title
