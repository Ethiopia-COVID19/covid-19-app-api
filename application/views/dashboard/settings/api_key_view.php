...
$url_key = $apiKeyContent->auth_url;
$client_id = $apiKeyContent->client_key;
$client_secret = $apiKeyContent->client_secret;
$report_url = $apiKeyContent->report_url;
                        ...
                        <div class="body">
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                    ...
                                    <input style="direction: ltr" type="text" name="auth_url" class="form-control" value="<?php echo $url_key; ?>" required>
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                    ...
                                    <input style="direction: ltr" type="text" name="client_id" class="form-control" value="<?php echo $client_id; ?>" required>
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                    ...
                                    <input style="direction: ltr" type="text" name="client_secret" class="form-control" value="<?php echo $client_secret; ?>" required>

                                    <label class="form-label">CLIENT SEECRET</label>
                              ...
                              <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                    ...
                                    <input style="direction: ltr" type="text" name="report_url" class="form-control" value="<?php echo $report_url; ?>" required>
