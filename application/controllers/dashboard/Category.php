...

{
...

    {
...

        {
            ...
            $this->form_validation->set_rules('Id', $this->lang->line("languages"), 'trim|required|xss_clean');
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $dataArray = array(
                    ...
                    "category_language_id" => $this->input->post('Id'),
        ...
        $data["language"] = $this->Category_model->get_language('languages')->result();
