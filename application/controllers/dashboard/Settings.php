...

{
...

        {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $dataArray = array(
                    ...
                    "client_key" => $this->input->post('client_id'),
                
                    "client_secret" => $this->input->post('client_secret'),
                
                    "report_url" => $this->input->post('report_url'),
...

    {
...

        {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $response = $this->Shared_model->send_push_notification_one_signal($push_notification_title, $push_notification_message, $push_notification_external_link);
 ...
 $dataArray = array(
                    ...
                    "title" => $this->input->post('push_notification_title'),

                    "message" => $this->input->post('push_notification_message'),

                    "url" => $this->input->post('push_notification_external_link'),
                    ...
                    $result = $this->Common_model->data_insert("push_notifications",$dataArray);
