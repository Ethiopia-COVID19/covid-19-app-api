        ...
        <li class="<?php if ($last_segment == "content_list" or $last_segment == "add_content" or $last_segment == "edit_content" or $last_segment == "show_content") echo $active_menu;  ?>">
            ...
            <ul class="ml-menu font-regular">
                 ...
                 <li class="<?php if ($last_segment == "users_list") echo $active_menu; ?>">
                    ...
                    <a href="<?php echo base_url()."dashboard/Report/users_activity"; ?>"><?php echo $this->lang->line("Summary"); ?></a>

                </li>

                <li class="<?php if ($last_segment == "add_user") echo $active_menu; ?>">

                    <a href="<?php echo base_url()."dashboard/Report/users_list2"; ?>"><?php echo $this->lang->line("Case List"); ?></a>
...
<!-- 
     ...
     <!--    <li class="<?php if ($last_segment == "sliders") echo $active_menu; ?>">
       ...
       <!--  <li class="<?php if ($last_segment == "push_notification") echo $active_menu; ?>">
             ...
             <a href="javascript:void(0);" class="menu-toggle">
                ...
                <span><?php echo $this->lang->line("view Push Notification"); ?></span>
             ...
             <ul class="ml-menu font-regular">
                ...
                <li class="<?php if ($last_segment == "push_notification") echo $active_menu; ?>">
                    ...
                    <a href="<?php echo base_url()."dashboard/Report/users_list3"; ?>">

                     <?php echo $this->lang->line("view Push Notification"); ?>
 ...
 <!-- Users Management -->
  ...
  <li class="<?php if ($last_segment == "api_key") echo $active_menu; ?>">
            ...
            <a href="<?php echo base_url()."dashboard/Settings/api_key" ?>">
        ...
        <!-- <li class="">
            ...
            <a target="_blank" href="http://www.inw24.com/user_manual/coronavirus/">
...
<div class="legal" style="direction: <?php echo $this->lang->line("app_direction"); ?>">
    ...
    <div class="copyright">
        ...
        &copy; <?php if ($this->lang->line("date-format") == "default") echo mdate('%Y'); elseif($this->lang->line("date-format") == "jdf") echo $this->jdf->jdate('Y'); else echo mdate('%Y'); ?> <a target="_blank" href="<?php echo "http://www.MOE.com" ?>"><?php echo $this->lang->line("Footer Copyright"); ?></a>.
